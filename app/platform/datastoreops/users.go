...
func (ds *DMStore) GetOrUpdateUser(ctx context.Context, lu *apppdrepo.LocalUserM, createIfInvited bool, useDefaultOrganization bool, ctxClaim map[string]string) (*models.Users, error) {
	result := []*models.Users{}
	var err error
...
func (ds *DMStore) CreateUser(ctx context.Context, lu *apppdrepo.LocalUserM, uo *models.Users, ctxClaim map[string]string) (*models.Users, error) {
...
func (ds *DMStore) LogPlatformRTinfo(ctx context.Context, obj *models.RefreshTokenLog, ctxClaim map[string]string) error {
...
func (ds *DMStore) LogPlatformJwtinfo(ctx context.Context, obj *models.JwtLog, ctxClaim map[string]string) error {
	obj.SetAccountId(ctxClaim[encryption.ClaimAccountKey])
...
func (ds *DMStore) GetPlatformRTinfo(ctx context.Context, token string, ctxClaim map[string]string) (*models.RefreshTokenLog, error) {
...
func (ds *DMStore) GetOrganizationUsers(ctx context.Context, organization string, ctxClaim map[string]string) ([]*models.Users, error) {
	result := []*models.Users{}
