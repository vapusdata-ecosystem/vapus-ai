...
func (ds *DMStore) CreateVapusSecret(ctx context.Context, obj *models.SecretStore, ctxClaim map[string]string) error {
...
func (ds *DMStore) ListVapusSecrets(ctx context.Context, condition string, ctxClaim map[string]string) ([]*models.SecretStore, error) {
...
func (ds *DMStore) GetVapusSecret(ctx context.Context, iden string, ctxClaim map[string]string) (*models.SecretStore, error) {
	if iden == "" {
...
func (ds *DMStore) PutVapusSecret(ctx context.Context, obj *models.SecretStore, ctxClaim map[string]string) error {
...
func (ds *DMStore) DeleteVapusSecret(ctx context.Context, iden string, ctxClaim map[string]string) error {
