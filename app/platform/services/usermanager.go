...
func (x *DMServices) NewUserManagerAgent(ctx context.Context, managerRequest *pb.UserManagerRequest, getterRequest *pb.UserGetterRequest) (*UserManagerAgent, error) {
