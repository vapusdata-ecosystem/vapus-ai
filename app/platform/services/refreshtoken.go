...
func (dms *DMServices) RefreshTokenAgentHandler(ctx context.Context, managerRequest *pb.RefreshTokenManagerRequest, getterRequest *pb.RefreshTokenGetterRequest) (*pb.RefreshTokenResponse, error) {
