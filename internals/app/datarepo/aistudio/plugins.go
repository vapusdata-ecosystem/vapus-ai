...
func (ds *AIStudioDMStore) ConfigurePlugin(ctx context.Context, obj *models.Plugin, ctxClaim map[string]string) error {
...
func (ds *AIStudioDMStore) ListPlugins(ctx context.Context, condition string, ctxClaim map[string]string) ([]*models.Plugin, error) {
...
func (ds *AIStudioDMStore) CountPlugins(ctx context.Context, condition string, ctxClaim map[string]string) (int64, error) {
	var result int64
	condition = apppkgs.GetAccountFilter(ctxClaim, condition)
...
func (ds *AIStudioDMStore) GetPlugin(ctx context.Context, iden string, ctxClaim map[string]string) (*models.Plugin, error) {
	if iden == "" {
...
func (ds *AIStudioDMStore) PutPlugin(ctx context.Context, obj *models.Plugin, ctxClaim map[string]string) error {
...
// func (ds *AIStudioDMStore) SetPluginCreds(ctx context.Context, secretName string, creds *models.GenericCredentialModel, ctxClaim map[string]string) error {
...
// func (ds *AIStudioDMStore) GetPluginCreds(ctx context.Context, secretName string, creds *models.GenericCredentialModel, ctxClaim map[string]string) error {
// 	result, err := dmutils.StructToMap(creds)
// 	if err != nil {
// 		logger.Err(err).Ctx(ctx).Msgf("error while converting struct to map")
// 		return err
